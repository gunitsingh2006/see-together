...
const description = "Create a private 2-person room, share a browser tab with screen audio, and watch in sync. Peer-to-peer over WebRTC — no uploads, no accounts.";
